package com.farmaciasperuanas.pmmli.localstore.util;
...
public class Constants {
    ...
    public static final String TRF_REASON_CODE = "10";
    public static final String NAME_TRANSACTION = "Extornos LI";
