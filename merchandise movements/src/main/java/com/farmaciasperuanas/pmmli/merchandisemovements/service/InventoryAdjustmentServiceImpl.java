    ...
    public ResponseDto enviarControlInventarioLi(List<InventoryAdjustmentDto> inventoryAdjustmentDtoList) {
        ...
        try{
            ...
            for(InventoryAdjustmentDto inventoryAdjustmentDto: inventoryAdjustmentDtoList){
                ...
                inventoryAdjustment.setTransAudited("F");
                ...
                inventoryAdjustment.setTransDate(inventoryAdjustment.getTransDate());
                ...
                inventoryAdjustment.setTransCurrCode("PEN");
                inventoryAdjustment.setTransOrgLvlNumber(9002);
